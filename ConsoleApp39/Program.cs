...
namespace ConsoleApp39
{
    class Program
    {
        ...
        public static bool Check(List<int> A, int B, int mid)
        {
            var lastPlacedCow = A[0];
            int numsOfCows = 1;
