    ...
    class Program
    {
        ...
        static class Solution
        {
            ...
            public static int firstMissingPositive(List<int> A)
            {
                ...
                while (i < n)
                {
                    if (A[i] >= 1 && A[i] <= A.Count)
                    {
                        int correctIndex = A[i] - 1;
                        if (A[correctIndex] != A[i]) //not seated at right seat
                        {
